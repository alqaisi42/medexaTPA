...
export function buildProceduresUrl(path: string, searchParams?: URLSearchParams) {
...
export async function forwardProceduresRequest(
    path: string,
    init?: RequestInit,
    searchParams?: URLSearchParams,
) {
    const response = await fetch(buildProceduresUrl(path, searchParams), {
        ...init,
        headers: {
