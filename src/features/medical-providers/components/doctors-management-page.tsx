            ...
            <div className="flex items-center justify-between gap-4 flex-wrap">
                <div>
                    ...
                    <p className="text-gray-600 max-w-2xl">
                        Manage all doctors in the system with quick add, edit, and delete actions. Keep your doctor
                        records consistent across the platform.
                    </p>
                </div>
            ...
            <div className="bg-white rounded-lg shadow p-4">
                ...
                <div className="rounded-lg border border-gray-100 overflow-hidden">
                    <Table>
                        <TableHeader>
                            <TableRow>
                                <TableHead className="w-36 font-semibold">Code</TableHead>
