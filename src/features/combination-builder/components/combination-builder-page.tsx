...
export function CombinationBuilderPage() {
    ...
    const activeCategoryFilledCount = activeFactorCategory
        ...
        : 0
    const pricingSummary = calculatePricingSummary(ruleForm)
    const discountSummary = summarizeDiscount(ruleForm)
    const adjustmentSummary = summarizeAdjustment(ruleForm)
    const effectiveRangeSummary = summarizeEffectiveness(ruleForm)
